...
class FileNotebookTests: XCTestCase {
  ...
  func testFileNotebook_whenAddNote_noteSavedInNotes() {
    let note = Note(title: "Title", content: "Text", importance: .regular, selfDestructDate: nil)
    sut.add(note)
  ...
  func testFileNotebook_whenAddNoteWithChangedInfo_updateNoteInNotes() {
    ...
    let note2 = Note(uid: note.uid, title: "New Title", content: "My new text", color: .red, importance: .important, selfDestructDate: Date())
    sut.add(note2)
  ...
  func testFileNotebook_whenSaveToFileAndLoadFromFile_equalsRestoredNotes() {
    ...
    let note2 = Note(title: "New Title", content: "My new text", color: .red, importance: .important, selfDestructDate: nil)
    sut.add(note2)
